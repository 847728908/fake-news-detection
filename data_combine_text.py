...
def evaluate_results(result_file, result_real_file):
    ...
    try:
        ...
        print(f"假新闻F1-score: {f1_fake:.4f}")
        print(f"真新闻F1-score: {f1_real:.4f}")
...
def main():
    ...
    result_file = Path(r"C:\Users\84772\Desktop\try\result_combine_text_newprompt.txt")
    result_real_file = Path(r"C:\Users\84772\Desktop\try\result_real_combine_text_newprompt.txt")
